...
Calendar 0.6.6 produces standard `.ics` files for one event, the visible range,
...
There is no Calendar subscription URL in 0.6.6. Calendar cannot add certified
...
| Not applicable | Google/Outlook URL subscription | Withheld: Calendar 0.6.6 exposes no feed URL. |
